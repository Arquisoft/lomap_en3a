...
* Only those who are friends or belong to the same group will be able to see the information of a user destined to them or the specified group.
- Robustness
* The system will work accordingly under all specified conditions.

.Change Scenarios
* The api used for the map can ve changed with no major modifications on the system's modules other than the view.
