...
The user will be able to add new friends with their POD's IDs. The application will try to request the friend's data and add a new friend to the user's POD. In case something goes wrong (invalid ID, connection error, etc.) the operation will be aborted and an error message will be displayed.
