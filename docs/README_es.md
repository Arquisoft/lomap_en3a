...
la url en la que se despliega es: [https://arquisoft.github.io/lomap_en3a/](https://arquisoft.github.io/lomap_en3a/).
...
Si queremos desplegar la documentación en GitHub pages, estará accesible en [https://arquisoft.github.io/lomap_en3a/](https://arquisoft.github.io/lomap_en3a/) necesitamos ejecutar `npm run deploy`.
