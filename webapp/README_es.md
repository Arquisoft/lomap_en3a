...
El flujo de trabajo se encuentra en el archivo [lomap_en3a.yml](.github/workflows/lomap_en3a.yml).  Si lo revisas podrás ver que existen dos trabajos, uno para la restapi(**unit-test-restapi**) y otro para la webapp(**unit-test-webapp**). Estos trabajos se ejecutan de forma paralela por lo que aceleran la construcción de las imágenes. 
